...
\begin{cv}{\myDocumentTitle}
    ...
    \begin{cvlist}{\myDocumentAuthor}
        \item[\de{Geburtsdatum}\en{Date of Birth}]
        ...
        \item[\de{Familienstand}\en{Marital Status}]
            \de{Ledig}
            \en{Single}
        ...
        \item[\de{E-Mail-Adresse}\en{E-Mail Address}]
            noodly.monster@student.pastauniversity.at
        
        \item [\de{Telefonnummer}\en{Phone Number}]
            +43 (0)190 888 6969
