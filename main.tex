...
\begin{cv}{\myDocumentTitle}
    ...
    \begin{cvlist}{\myDocumentAuthor}
        ...
        \item[\de{Staatsbürgerschaft}\en{Nationality}]
            \de{Österreich}
            \en{Austria}
        ...
        \item[\de{Führerschein}\en{Driving License}]
            \de{A, B}
    ...
    % mention your hightest degree here instead of the (normal) education listing.
    % explicitely mention the institution. in austria this means University, Fasthochschule, Html or Matura.
    ...
    \begin{cvlist}{\de{Berufserfahrung}\en{Employment}}
        \item[2013-2014] 
            \de{Gottheit}
            \en{Deity}\\
    ...
    % if you are a technicial, explicitely mention your soft skills
    ...
    % exclusive/voluntary education that does not belong to your study
